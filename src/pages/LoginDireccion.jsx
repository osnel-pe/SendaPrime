...
export default function LoginDireccion({
  cambiarPantalla,
  ...
  async function iniciarSesion() {
    ...
    if (data.usuario.trim().toLowerCase() !== correo.trim().toLowerCase()) {
      ...
      setError('Esta cuenta no pertenece al área de Dirección');
      ...
      <div className="app">
        ...
        >
          ...
          <div className="footer-login">
            ...
            <span>Área exclusiva de Dirección</span>
          </div>
        </motion.div>
      </div>
    </>
